	...
	public void render(Graphics g) {
		if (!loaded) {
			...
			cancelButton = new Rectangle(game.getWidth() - (int) ((double) this.game.getWidth() * 10.0 / 192.0),
					(int) ((double) game.getHeight() * 19.0 / 1080),
					(int) ((double) this.game.getWidth() * 25.0 / 1920.0),
					(int) ((double) this.game.getHeight() * 33.0 / 1080.0));

			// plant backgrounds
			this.plantBackground = getScaledImage("/plant_select.png", rectWidth, rectHeight, this.originalWidth,
					this.originalHeight);

			this.plantBackgroundText = getScaledImage("/plant_select_text.png", rectWidth, rectHeight,
					this.originalWidth, this.originalHeight);

			// fire backgrounds
			this.fireBackground = getScaledImage("/fire_select.png", rectWidth, rectHeight, this.originalWidth,
					this.originalHeight);

			this.fireBackgroundText = getScaledImage("/fire_select_text.png", rectWidth, rectHeight, this.originalWidth,
					this.originalHeight);

			// plant backgrounds
			this.waterBackground = getScaledImage("/water_select.png", rectWidth, rectHeight, this.originalWidth,
					this.originalHeight);

			this.waterBackgroundText = getScaledImage("/water_select_text.png", rectWidth, rectHeight,
					this.originalWidth, this.originalHeight);

			// random Background

			this.randomBackground = getScaledImage("/random_select.png", rectWidth, rectHeight, this.originalWidth,
					this.originalHeight);

			this.randomBackgroundText = getScaledImage("/random_select_text.png", rectWidth, rectHeight,
					this.originalWidth, this.originalHeight);
		...
		case Pickphase:
			...
			g2d.drawString("select a character to proceed",
					(int) ((game.getWidth() - g.getFontMetrics().stringWidth("select a character to proceed")) / 2),
		...
		case Pickphase_confirm:
			...
			g2d.drawString(tempSelectText, (int) ((this.game.getWidth() + preScaledRandom[0].getWidth()) / 2
